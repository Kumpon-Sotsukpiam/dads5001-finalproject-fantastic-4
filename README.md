...
> 🌐 **Live app:** (https://dads5001-finalproject-fantastic-4-zg4hptp4pvp6hyac7nwknp.streamlit.app)
...
```
├── app.py                      # Entrypoint: st.navigation (page labels & order)
├── home.py                     # Home: hero, motivation, objective, story flow
├── pages/
